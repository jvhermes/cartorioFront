...
export function ModalNewProcess({ isOpen, onRequestClose, setorList, tipoList, loteList }: ModalNewProcessProps,) {
    ...
    function handleChangeNomeDesc(e, index) {
        descricao[index].nome = e.target.value
        setDescricao([...descricao])
    }
    function handleChangeCpfDesc(e, index) {
        descricao[index].cpf = e.target.value
        setDescricao([...descricao])
    }
    function handleChangeEmailDesc(e, index) {
        descricao[index].email = e.target.value
        setDescricao([...descricao])
    }
    function handleChangeTelefoneDesc(e, index) {
        descricao[index].telefone = e.target.value
        setDescricao([...descricao])
    }
    ...
    async function handleNewProcess() {
        ...
        const tipo_id = tipos[selectTipo].id
        const prazo = 180
        ...
        try {
            await apiClient.post("/processocartorio", {
                observacao, prazo, descricao, lote_id, memorando,
        ...
        <Modal isOpen={isOpen} onRequestClose={onRequestClose} style={customStyles}>
            ...
            <div className={styles.base}>
                <div>
                    ...
                    <Dropdown name="tipo" id="tipo" selection value={selectTipo} onChange={(e) => handleChangeTipo(e)}
                        options={
            ...
            <div className={styles.content}>
                ...
                <div className={styles.description}>
                    ...
                    <div className={styles.descriptionMemorando}>
                        <label htmlFor="memo">Memorando:</label>
                        <textarea id="memo" name="memorando" placeholder="Memorando" value={memorando} maxLength={147} onChange={(e) => setMemorando(e.target.value)}></textarea>
                    </div>
